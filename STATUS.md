...
| ------------------ | --------------------------------- | ---- | ------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| openclaw | fix/diagnostic-dev-host | #142 | in review | Claude | scripts/ops/agents_server_diagnostic.sh, STATUS.md | bash -n clean; shellcheck --severity=error clean (docker); --no-write all ran against eu+us+dev, all reachable | owner merge; the 05:40 autoscan re-pin picks it up, 06:00 run covers dev next morning. Owner: DevAgents root disk is 100% (first dev probe, P0) — clear before any agent deploy there | Adds dev (DevAgents 204.168.223.245) to host_ip/host_label/ALL_HOSTS/arg parser. Not done: diagnostic-cron.sh 2.5/2.6 prod-IP loops (image prune on the build host is its own decision); D3 CORE_APIS lacks ANTHROPIC_API_KEY (drift since dashboard #443). |
